...
printText('yes'); //prints 'yes' when called
printText('no'); //prints 'no' when called
...
console.log(triple(5)); //to print out when returned


let lives = triple(7); //to save the value returned in the rest of the program
...
console.log(x); //y and z are not accessible outside the {} they were created
...
console.log(n); //since there is no direction to go to {}, it uses global n
